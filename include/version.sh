...
Luajit_Ver='luajit2-2.1-20220915'
LuaNginxModule='lua-nginx-module-0.10.22'
LuaRestyCore='lua-resty-core-0.1.24'
...
if [ "${DBSelect}" = "1" ]; then
    ...
    Mysql_Ver='mysql-8.0.31'
elif [ "${DBSelect}" = "6" ]; then
    Mariadb_Ver='mariadb-5.5.68'
elif [ "${DBSelect}" = "7" ]; then
    Mariadb_Ver='mariadb-10.3.37'
elif [ "${DBSelect}" = "8" ]; then
    Mariadb_Ver='mariadb-10.4.27'
elif [ "${DBSelect}" = "9" ]; then
    Mariadb_Ver='mariadb-10.5.18'
elif [ "${DBSelect}" = "10" ]; then
    Mariadb_Ver='mariadb-10.6.11'
fi
if [ "${PHPSelect}" = "1" ]; then
    Php_Ver='php-5.2.17'
